  ...
  return (
    <form className="ordering">
      <div className="ordering__total">
        ...
        <div className="ordering__goods">Всего товаров: <span>15 шт.</span></div>
        <div className="ordering__amount">На сумму: <span>10 000 руб.</span></div>
      </div>

      <div className="ordering-delivery">
        <label htmlFor="ordering-delivery" className="ordering-delivery__label">Выберите вариант доставки:</label>
        <select name="sort" id="ordering-delivery" className="ordering-delivery__select">
      ...
      <div className="ordering-payment">
        <label htmlFor="ordering-payment" className="ordering-payment__label">Выберите вариант оплаты:</label>
        <select name="sort" id="ordering-payment" className="ordering-payment__select">
      ...
      <div className="ordering-phone">
        <label className="ordering-phone__label" htmlFor="phone">Укажите номер телефона:</label>
        <input className="ordering-phone__input" type="tel" id="phone" required />
      </div>

      <div className="ordering-comment">
        <label className="ordering-comment__label" htmlFor="comment">Введите комментарий к заказу (не
          обязательно):</label>
        <textarea className="ordering-comment__text" name="comment" id="comment"></textarea>
      </div>
